-- FUNCTIONS:
-- 1. Функция за изчисляване на средната оценка за даден продукт:
...
-- 2. Функция за изчисляване на общия доход на даден продавач:
...
-- 3. Функция за изчисляване на броя на активните продукти в дадена категория:
